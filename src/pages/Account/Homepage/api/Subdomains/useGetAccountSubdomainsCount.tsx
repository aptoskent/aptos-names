...
export function useGetAccountSubdomainsCount() {
  ...
  function gotTotalSubdomains(owner_address: string) {
  ...
  const totalSubdomainsCount =
    data && data.current_token_ownerships_aggregate?.aggregate?.count;

  return {gotTotalSubdomains, totalSubdomainsCount};
}
